	...
	window.draggable = function(ele, _options) {
		...
		addEvent(ele, "mousedown", function(e){
			...
			function move(e){
				...
				var section = {
					minLeft : options.paddingLeft - options.marginLeft,
					maxLeft : ele.offsetParent.offsetParent.offsetWidth - ele.offsetWidth - options.paddingRight - options.marginLeft,
					minTop : options.paddingTop - options.marginTop,
					maxTop : (ele.offsetParent.offsetParent.offsetHeight - ele.offsetParent.offsetHeight) - options.paddingBottom - options.marginTop
				}
			...
			addEvent(document, "mouseup", function(e){
				...
				options.callbackEnd && options.callbackEnd({x:offsetPage(ele).left - startPoint.x,y:offsetPage(ele).top - startPoint.y,max: (ele.offsetParent.offsetHeight - ele.offsetHeight) - options.paddingBottom - options.marginTop});
			});
		});
