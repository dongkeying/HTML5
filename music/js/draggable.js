	...
	window.draggable = function(ele, _options) {
		...
		addEvent(ele, "mousedown", function(e){
			...
			addEvent(document, "mouseup", function(e){
				...
				options.callbackEnd && options.callbackEnd({x:offsetPage(ele).left - startPoint.x,y:offsetPage(ele).top - startPoint.y,max:ele.offsetParent.offsetParent.offsetWidth - ele.offsetWidth - options.paddingRight - options.marginLeft});
			});
		});
